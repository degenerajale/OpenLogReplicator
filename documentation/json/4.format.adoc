...
* `12` — Unix epoch with nanosecond precision as a number, time zone dropped — `"tm": 1651384800123456789`. Same encoding and range (1677–2262) as `timestamp-format` `0`.
* `13` — Unix epoch with microsecond precision as a number, time zone dropped (possible data precision loss) — `"tm": 1651384800123457`.
* `14` — Unix epoch with millisecond precision as a number, time zone dropped (possible data precision loss) — `"tm": 1651384800123`.
* `15` — Unix epoch with second precision as a number, time zone dropped (possible data precision loss) — `"tm": 1651384800`.

Values `12`–`15` emit the instant only; the stored time zone is a presentation attribute of the value and does not change the instant.
